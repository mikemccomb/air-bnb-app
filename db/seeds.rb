...
room = Room.new(user_id: 1, address: "123 Hollywood Blvd", city: "Los Angeles", state: "California", price: 300, description: "Come stay at Jason Nesmith's home set in the idyllic Hollywood Hills. Watch out for foreign invaders", home_type: "Mansion Home", room_type: "Private", total_occupancy: 12, total_bedrooms: 8, total_bathrooms: 4)
room.save

room = Room.new(user_id: 2, address: "190 W Sixth Street", city: "Boston", state: "Massachusetts", price: 100, description: "Have you ever met a Will Hunting you didn't like? Now you have the chance to stay in his three flat! Located right in the heart of Boston", home_type: "Apartment", room_type: "Shared", total_occupancy: 3, total_bedrooms: 2, total_bathrooms: 1)
room.save

room = Room.new(user_id: 3, address: "6409 Wilbur Drive", city: "Austin", state: "Texas", price: 200, description: "You won't be confused, but you will be dazed at Carl's cool house. Located on the beautiful streets of Austin!", home_type: "Single-Family Home", room_type: "Private", total_occupancy: 12, total_bedrooms: 4, total_bathrooms: 3)
room.save

room = Room.new(user_id: 4, address: "122 Callahan Drive", city: "Sandusky", state: "Ohio", price: 250, description: "Want to live in the coolest house in the middle of nowhere? Come visit Callahan Auto Parts and hangout with Tomy", home_type: "Mansion", room_type: "Private", total_occupancy: 12, total_bedrooms: 8, total_bathrooms: 6)
room.save
